document.addEventListener('DOMContentLoaded', () => {
    ...
    let originalValues = [
        ...
        { name: "Благодарность", description: "Быть благодарным за добро и выражать признательность." },
        ...
        { name: "Устойчивое развитие", description: "Удовлетворение потребностей без ущерба для будущих поколений." },
